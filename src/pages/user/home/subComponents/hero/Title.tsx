  ...
  return (
    <div className="flex flex-col gap-4 items-center lg:items-start">
      <h1 className="md:text-5xl lg:text-[3vw]  text-4xl font-bold text-blue-950 text-center lg:text-left">
        Where <span className="text-yellow-500">Leather </span> Meets Innovation
      ...
      <button className="bg-blue-600  flex items-center justify-center gap-2  lg:mx-0 text-white px-12 w-[13rem] rounded-lg py-4">
        <h1>Explore</h1>
        <HiOutlineArrowRight />
      </button> 
    </div>
